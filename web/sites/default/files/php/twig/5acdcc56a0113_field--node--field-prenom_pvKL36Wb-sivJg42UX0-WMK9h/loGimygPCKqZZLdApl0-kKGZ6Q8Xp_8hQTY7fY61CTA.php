...
/* themes/custom/mba/templates/field/field--node--field-prenom--intervenant.html.twig */
class __TwigTemplate_6692fcbcfe6a864831bb240fd49b4a4022cf829bef1d7d5eb40d7cb85e80b507 extends Twig_Template
{
...
($context["label_display"] ?? null) == "visually_hidden")) ? ("sr-only") : ("")));
  ...
  ";
    ...
    ";
      ...
      ";
                // line 75
                if ((($this->getAttribute(($context["element"] ?? null), "#view_mode", array(), "array") == "teaser") || ($this->getAttribute(($context["element"] ?? null), "#view_mode", array(), "array") == "champ_unique"))) {
                    // line 76
                    echo "        <a href=\"";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "content", array()), "#url", array(), "array"), "html", null, true));
                    echo "\" class=\"use-ajax\" data-dialog-type=\"modal\">";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "content", array()), "#title", array(), "array"), "html", null, true));
                    echo "</a>
      ";
                } else {
                    // line 78
...
";
    ...
    {
        return "themes/custom/mba/templates/field/field--node--field-prenom--intervenant.html.twig";
    }
    ...
    {
        return array (  158 => 86,  154 => 84,  151 => 83,  143 => 80,  137 => 78,  129 => 76,  127 => 75,  122 => 74,  117 => 73,  113 => 71,  111 => 70,  105 => 69,  100 => 68,  96 => 66,  85 => 64,  80 => 63,  76 => 61,  65 => 59,  61 => 58,  56 => 57,  53 => 56,  51 => 55,  49 => 52,  48 => 50,  46 => 46,  45 => 45,  44 => 44,  43 => 42,);
    }
    ...
    {
        return new Twig_Source("", "themes/custom/mba/templates/field/field--node--field-prenom--intervenant.html.twig", "/home/www/spiravita/web/themes/custom/mba/templates/field/field--node--field-prenom--intervenant.html.twig");
    }
}
